...
jquery__WEBPACK_IMPORTED_MODULE_0___default()("[data-menu='true']").click(function () {
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(openedMenu).slideToggle("show");
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(megamenu).slideToggle();
  if (!isOpen) {
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(".close-profile-sidebar").click(function () {
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('.profile-sidebar').slideToggle();
  jquery__WEBPACK_IMPORTED_MODULE_0___default()("a[data-menu='true']").removeClass("open");
  jquery__WEBPACK_IMPORTED_MODULE_0___default()(".submenu").removeClass("show");
  jquery__WEBPACK_IMPORTED_MODULE_0___default()('body').removeClass('overflow-hidden');
});
